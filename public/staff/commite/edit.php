...
if(is_post_request()) {
  ...
  $getcommite = [];
  $getcommite['id'] = $id;
  $getcommite['nom'] = isset($_POST['commite_nom'])?$_POST['commite_nom'] : '';
  $getcommite['country'] = isset($_POST['country'])?$_POST['country'] : '';
  $getcommite['type'] = isset($_POST['commite_type'])?$_POST['commite_type'] : '';
  $getcommite['university'] = isset($_POST['commite_univ'])?$_POST['commite_univ'] : '';
